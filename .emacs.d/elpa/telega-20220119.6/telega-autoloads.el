...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("ids" "inactive-supergroups" "is-" "custom" "contact" "chat-list" "can-" "has-" "type" "top" "tracking" "folder" "fake-or-scam" "define-telega-filter" "default-disable-notification" "any" "all" "archive" "my-permission" "main" "last-message-by-me" "restriction" "replies-messages" "search" "saved-messages" "pin" "permission" "verified" "online-status" "unread" "unmuted" "not" "name" "nearby")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-sort" '("last-seen" "chat" "nearby-distance" "join-date" "order" "online-members" "member-count" "telega-" "title" "unread-count" "define-telega-sorter")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-tdlib-events" '("tracking-buffers" "telega-" "with-telega--msg-update-event")))
